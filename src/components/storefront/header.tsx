...
import { Receipt, ArrowUpRight, Menu } from "lucide-react";
  ...
  return (
    <header className="alpha-header">
      <div className="header-inner">
        ...
        <div className="header-actions"><Link href="/orders" className="header-icon" aria-label="My orders"><Receipt size={20} /></Link><Link href="/shop" className="header-shop">Explore guides <ArrowUpRight size={16} /></Link></div>
      </div>
      <details className="mobile-menu">
        ...
        <nav aria-label="Mobile navigation">
          ...
          <Link href="/orders">My orders<Receipt size={18} /></Link>
        </nav>
      </details>
    </header>
  );
